...
<head>
  ...
  <!-- sweetalert -->
  <link rel="stylesheet" href="bower_components/sweetalert/sweetalert2.min.css">
    <!-- DataTables -->
    <link rel="stylesheet" href="bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
    <link rel="stylesheet" href="bower_components/datatables.net-bs/css/dataTable.css">
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              ...
              <span class="hidden-xs"><?php echo $Y_user; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <li>
    ...
    <li <?=(isset($_GET['page']) && $_GET['page'] == 'monitoring' )?'class="active"':'';?>>
    ...
    <li <?=(isset($_GET['page']) && $_GET['page'] == 'reports' )?'class="active"':'';?>>
