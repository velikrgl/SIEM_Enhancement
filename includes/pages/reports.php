 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <br /><br />
      <div class="btn-group">
          <a href="admin.php?page=reports&filter=1" type="button" class="btn btn-danger">IP</a>
          <a href="admin.php?page=reports&filter=2" type="button" class="btn btn-default">HASH</a>
          <a href="admin.php?page=reports&filter=3" type="button" class="btn btn-default">URL</a>
      </div>
